...
- `Array.prototype.concat` -> `require('es5-ext/arraymainconcat')`
- `Array.prototype.copyWithin` -> `require('es5-ext/arraymaincopy-within')`
- `Array.prototype.entries` -> `require('es5-ext/arraymainentries')`
- `Array.prototype.fill` -> `require('es5-ext/arraymainfill')`
- `Array.prototype.filter` -> `require('es5-ext/arraymainfilter')`
- `Array.prototype.find` -> `require('es5-ext/arraymainfind')`
- `Array.prototype.findIndex` -> `require('es5-ext/arraymainfind-index')`
- `Array.prototype.keys` -> `require('es5-ext/arraymainkeys')`
- `Array.prototype.map` -> `require('es5-ext/arraymainmap')`
- `Array.prototype.slice` -> `require('es5-ext/arraymainslice')`
- `Array.prototype.splice` -> `require('es5-ext/arraymainsplice')`
- `Array.prototype.values` -> `require('es5-ext/arraymainvalues')`
- `Array.prototype[@@iterator]` -> `require('es5-ext/arraymain@@iterator')`
...
- `Promise.prototype.finally` -> `require('es5-ext/promisemainfinally')`
- `RegExp.prototype.match` -> `require('es5-ext/reg-expmainmatch')`
- `RegExp.prototype.replace` -> `require('es5-ext/reg-expmainreplace')`
- `RegExp.prototype.search` -> `require('es5-ext/reg-expmainsearch')`
- `RegExp.prototype.split` -> `require('es5-ext/reg-expmainsplit')`
- `RegExp.prototype.sticky` -> Implement with `require('es5-ext/reg-expmainsticky/implement')`, use as function with `require('es5-ext/reg-expmainis-sticky')`
- `RegExp.prototype.unicode` -> Implement with `require('es5-ext/reg-expmainunicode/implement')`, use as function with `require('es5-ext/reg-expmainis-unicode')`
- `String.fromCodePoint` -> `require('es5-ext/string/from-code-point')`
- `String.raw` -> `require('es5-ext/string/raw')`
- `String.prototype.codePointAt` -> `require('es5-ext/stringmaincode-point-at')`
- `String.prototype.contains` -> `require('es5-ext/stringmaincontains')`
- `String.prototype.endsWith` -> `require('es5-ext/stringmainends-with')`
- `String.prototype.normalize` -> `require('es5-ext/stringmainnormalize')`
- `String.prototype.repeat` -> `require('es5-ext/stringmainrepeat')`
- `String.prototype.startsWith` -> `require('es5-ext/stringmainstarts-with')`
- `String.prototype[@@iterator]` -> `require('es5-ext/stringmain@@iterator')`
...
Object.defineProperty(Function.prototype, "partial", {
  value: require("es5-ext/functionmainpartial"),
  configurable: true,
  enumerable: false,
  writable: true
});
Object.defineProperty(Array.prototype, "flatten", {
  value: require("es5-ext/arraymainflatten"),
  configurable: true,
  enumerable: false,
  writable: true
});
Object.defineProperty(String.prototype, "capitalize", {
  value: require("es5-ext/stringmaincapitalize"),
  configurable: true,
  enumerable: false,
  writable: true
});
...
```javascript
var flatten = require("es5-ext/arraymainflatten");
...
var flatten = call.bind(require("es5-ext/arraymainflatten"));
...
```javascript
var util = {};
util.partial = call.bind(require("es5-ext/functionmainpartial"));
util.flatten = call.bind(require("es5-ext/arraymainflatten"));
util.startsWith = call.bind(require("es5-ext/stringmainstarts-with"));
...
#### arr.binarySearch(compareFn) _(es5-ext/arraymainbinary-search)_

In **sorted** list search for index of item for which _compareFn_ returns value closest to _0_.
It's variant of binary search algorithm

#### arr.clear() _(es5-ext/arraymainclear)_

Clears the array

#### arr.compact() _(es5-ext/arraymaincompact)_

Returns a copy of the context with all non-values (`null` or `undefined`) removed.

#### arr.concat() _(es5-ext/arraymainconcat)_
...
#### arr.contains(searchElement[, position]) _(es5-ext/arraymaincontains)_

Whether list contains the given value.

#### arr.copyWithin(target, start[, end]) _(es5-ext/arraymaincopy-within)_

[_Introduced with ECMAScript 6_](http://people.mozilla.org/~jorendorff/es6-draft.html#sec-array.copywithin).

#### arr.diff(other) _(es5-ext/arraymaindiff)_

Returns the array of elements that are present in context list but not present in other list.

#### arr.eIndexOf(searchElement[, fromIndex]) _(es5-ext/arraymaine-index-of)_
...
#### arr.eLastIndexOf(searchElement[, fromIndex]) _(es5-ext/arraymaine-last-index-of)_
...
#### arr.entries() _(es5-ext/arraymainentries)_
...
#### arr.find(predicate[, thisArg]) _(es5-ext/arraymainfind)_
...
#### arr.findIndex(predicate[, thisArg]) _(es5-ext/arraymainfind-index)_
...
#### arr.first() _(es5-ext/arraymainfirst)_

Returns value for first defined index

#### arr.firstIndex() _(es5-ext/arraymainfirst-index)_

Returns first declared index of the array

#### arr.flatten() _(es5-ext/arraymainflatten)_

Returns flattened version of the array

#### arr.forEachRight(cb[, thisArg]) _(es5-ext/arraymainfor-each-right)_

`forEach` starting from last element

#### arr.group(cb[, thisArg]) _(es5-ext/arraymaingroup)_

Group list elements by value returned by _cb_ function

#### arr.indexesOf(searchElement[, fromIndex]) _(es5-ext/arraymainindexes-of)_

Returns array of all indexes of given value

#### arr.intersection([…lists]) _(es5-ext/arraymainintersection)_

Computes the array of values that are the intersection of all lists (context list and lists given in arguments)

#### arr.isCopy(other) _(es5-ext/arraymainis-copy)_

Returns true if both context and _other_ lists have same content

#### arr.isUniq() _(es5-ext/arraymainis-uniq)_

Returns true if all values in array are unique

#### arr.keys() _(es5-ext/arraymainkeys)_
...
#### arr.last() _(es5-ext/arraymainlast)_

Returns value of last defined index

#### arr.lastIndex() _(es5-ext/arraymainlast)_

Returns last defined index of the array

#### arr.map(callback[, thisArg]) _(es5-ext/arraymainmap)_
...
#### arr.remove(value[, …valuen]) _(es5-ext/arraymainremove)_

Remove values from the array

#### arr.separate(sep) _(es5-ext/arraymainseparate)_

Returns array with items separated with `sep` value

#### arr.slice(callback[, thisArg]) _(es5-ext/arraymainslice)_
...
#### arr.someRight(cb[, thisArg]) _(es5-ext/arraymainsomeRight)_

`some` starting from last element

#### arr.splice(callback[, thisArg]) _(es5-ext/arraymainsplice)_
...
#### arr.uniq() _(es5-ext/arraymainuniq)_

Returns duplicate-free version of the array

#### arr.values() _(es5-ext/arraymainvalues)_
...
#### arr[@@iterator] _(es5-ext/arraymain@@iterator)_
...
#### date.copy(date) _(es5-ext/datemaincopy)_

Returns a copy of the date object

#### date.daysInMonth() _(es5-ext/datemaindays-in-month)_

Returns number of days of date's month

#### date.floorDay() _(es5-ext/datemainfloor-day)_

Sets the date time to 00:00:00.000

#### date.floorMonth() _(es5-ext/datemainfloor-month)_

Sets date day to 1 and date time to 00:00:00.000

#### date.floorYear() _(es5-ext/datemainfloor-year)_

Sets date month to 0, day to 1 and date time to 00:00:00.000

#### date.format(pattern) _(es5-ext/datemainformat)_
...
#### err.throw() _(es5-ext/errormainthrow)_
...
#### fn.compose([…fns]) _(es5-ext/functionmaincompose)_
...
#### fn.copy() _(es5-ext/functionmaincopy)_

Produces copy of given function

#### fn.curry([n]) _(es5-ext/functionmaincurry)_
...
#### fn.lock([…args]) _(es5-ext/functionmainlock)_
...
#### num.pad(length[, precision]) _(es5-ext/numbermainpad)_
...
#### promise.finally(onFinally) _(es5-ext/promisemainfinally)_
...
#### re.isSticky(x) _(es5-ext/reg-expmainis-sticky)_
...
#### re.isUnicode(x) _(es5-ext/reg-expmainis-unicode)_
...
#### re.unicode _(es5-ext/reg-expmainunicode/implement)_
...
#### str.at(pos) _(es5-ext/stringmainat)_
...
#### str.camelToHyphen() _(es5-ext/stringmaincamel-to-hyphen)_
...
#### str.capitalize() _(es5-ext/stringmaincapitalize)_

Capitalize first character of a string

#### str.caseInsensitiveCompare(str) _(es5-ext/stringmaincase-insensitive-compare)_

Case insensitive compare

#### str.codePointAt(pos) _(es5-ext/stringmaincode-point-at)_
...
#### str.indent(str[, count]) _(es5-ext/stringmainindent)_

Indents each line with provided _str_ (if _count_ given then _str_ is repeated _count_ times).

#### str.last() _(es5-ext/stringmainlast)_

Return last character

#### str.normalize([form]) _(es5-ext/stringmainnormalize)_
...
#### str.plainReplace(search, replace) _(es5-ext/stringmainplain-replace)_
...
#### str.plainReplaceAll(search, replace) _(es5-ext/stringmainplain-replace-all)_
